    <fieldset>
        ...
        <textarea name="propiedad[descripcion]" id="descripcion" cols="30" rows="10" placeholder="Descripcion Propiedad">
    ...
    <fieldset>
        ...
        <select name="propiedad[vendedorId]" id="vendedor">
            ...
            <?php foreach ($vendedores as $vendedor) { ?>
                <option <?php echo $propiedad->vendedorId === $vendedor->id ? 'Selected' : '1' ?> value="<?php echo s($vendedor->id) ?>">
